...
class dsa6
{
	...
	public static void main(String ar[])throws Exception
	{
		...
		do
		{
			System.out.println("Enter your choice 1.Line Up the members 2.Process the member 3.Display the number of adults and children 4.Process the buffer/waiting list");
        ...
        public static void process_buff()
        {
     	 for(int i=0;i<buff_count++;i++)
         {
          System.out.println(buff[i]+" is processed");
          } 
         }
